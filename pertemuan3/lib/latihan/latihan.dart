...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      initialRoute: '/', // Halaman pertama yang bakal muncul pas app dibuka
      routes: {
        '/': (context) => const HomePage(), // Alamat untuk HomePage
      },
...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // MODIFIKASI LALU COBA SENDIRI DI AKHIR LANGKAH 3.2:
      // Mengubah fungsi tombol + agar membuka halaman TambahCatatanPage
...
// HALAMAN TAMBAH CATATAN (LANGKAH 3.2)
