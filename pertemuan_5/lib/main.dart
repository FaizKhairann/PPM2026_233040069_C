...
// =====================================================================
//
// Catatan dikirim dan diterima sebagai JSON dari REST API.
class Catatan {
  final int? id;
  final String judul;
  final String isi;
      ...
      body: FutureBuilder<List<Catatan>>(
        ...
        builder: (context, snapshot) {
          ...
          if (snapshot.hasError) {
            ...
            return _ErrorState(
              pesan: e is ApiException ? e.message : 'Terjadi kesalahan: $e',
              onRetry: _muatUlang,
            );
          }
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            const Text('Gagal memuat catatan', style: TextStyle(fontSize: 18)),
